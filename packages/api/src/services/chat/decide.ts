...
const SYSTEM = [
	...
	'- website_audit: the user asks Rivus to audit, review, check over, or analyze their',
	...
	'  This is the ONLY web action: there is no generic web search or page fetching.',
